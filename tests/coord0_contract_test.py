...
def test_coordination_and_plan_convergence_is_explicit():
    ...
    assert re.search(
        r"^current_stage: (APP-TEXT|PUB-ACCOUNT|PUB-CORE|PUB-DOUYIN|APP-CAROUSEL|APP-IPB|PUB-INTEGRATION|E2E-DOUYIN|PROGRAM-ROLLOUT|PLATFORM-EXPANSION|APP-WORKBENCH|BRAND-PROJECT)$",
        progress,
        re.MULTILINE,
    )
    assert re.search(
